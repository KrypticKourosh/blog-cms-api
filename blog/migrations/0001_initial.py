...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['-slug'], name='blog_post_slug_dce016_idx'), models.Index(fields=['-title'], name='blog_post_title_2cc21d_idx'), models.Index(fields=['-status'], name='blog_post_status_7d15e2_idx'), models.Index(fields=['-created_at'], name='blog_post_created_45f0c6_idx')],
            },
        ),
    ]
